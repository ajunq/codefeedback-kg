...
\emergencystretch=2em  % absorbe overfull \hbox menores (solo afecta al corte de linea)
\begin{document}
...
In line with the journal's open-science policy, the Educational Knowledge Graph, SHACL shapes, evaluation scripts and the aggregated human-annotation results are made available to the maximum extent feasible, as detailed in the Reproducibility section. The project repository is at \texttt{https://github.com/ajunq/codefeedback-kg} (archived at Zenodo, DOI: \texttt{10.5281/zenodo.20804437}). The underlying Dublin DCU CS1 corpus is publicly available from its original source.
